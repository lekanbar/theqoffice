<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TemplateSearch.aspx.cs" 
...
<ContentTemplate>
    ...
    WEBSITE DESIGN THEME:  <asp:Label ID="lblWebsiteDesign" runat="server" ForeColor="Green" CssClass="right"
    Text="None selected yet"  ></asp:Label>
...
<ContentTemplate>
      ...
      <asp:ListView ID="LVTemplates" runat="server" ItemPlaceholderID="ItemContent" GroupPlaceholderID="GroupContent"
       GroupItemCount="3" DataKeyNames="SiteID" OnItemCommand="SelectTemplate" 
        ...
        <asp:DataPager ID="Pager" runat="server"  PagedControlID="LVTemplates" PageSize="6" EnableViewState="true" >                       
        <Fields>
        ...
        <ItemTemplate>
        <div >
        <div class="SampleSiteBg"  style="border:solid 1px #cccccc; padding:3px;">
            ...
            "/images/screenshot.jpg" %>' target="_blank" > 
