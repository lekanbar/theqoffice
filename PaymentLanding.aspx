<%@ Page Title="The Q-Office -> Setup" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PaymentLanding.aspx.cs" Inherits="PaymentLanding" %>
...
<hr />
 ...
 <center>
      <asp:LinkButton ID="lnkTryAgain" runat="server" Visible="false" OnClick="lnkTryAgain_Click">Click here to try again</asp:LinkButton>
  </center>
  </div>
   </div>
</asp:Content>
