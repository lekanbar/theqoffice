...
SEARCH OUR DIRECTORY
 ...
 <div  id="NormalContent">
    <div  class="NormalContentLeft">
        ADVANCED SEARCH 
        <div style="width:100%; direction:rtl; color:Yellow;">(optional)</div>
        <br />
        <asp:UpdatePanel ID="UpdatePanelAdvanced" runat="server">
        <ContentTemplate>
            <div style="color:#000000;  "> 
                Category:
                <asp:DropDownList ID="drpCategory" runat="server" Height="20px" Width="237px" 
                    DataSourceID="SDSBizCategories" DataTextField="CategoryTitle" 
                    DataValueField="CategoryTitle">
                </asp:DropDownList>
                <asp:SqlDataSource ID="SDSBizCategories" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:QOfficeDBConnectionString %>" 
                    SelectCommand="SELECT [CategoryTitle] FROM [TQO_BusinessCategories]">
                </asp:SqlDataSource>
                <br />
                ...
                <ContentTemplate>
                    ...
                    <asp:DropDownList ID="drpState" runat="server" AutoPostBack="True" 
                        Height="20px" onselectedindexchanged="drpState_SelectedIndexChanged" 
                        Width="237px">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem>Non-Nigerian</asp:ListItem>
                        <asp:ListItem>F.C.T.</asp:ListItem>
                    ...
                    <asp:Panel ID="pnlState" runat="server" Visible="false" >
                        ...
                        <asp:TextBox ID="txtState" runat="server" 
                            ValidationGroup="g2" Width="230px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ControlToValidate="txtState" ErrorMessage="*" ValidationGroup="g2"></asp:RequiredFieldValidator>
                    </asp:Panel>
                    <br />
                    Country:
                    <br />
                    <asp:DropDownList ID="drpCountry" runat="server" Height="20px" Width="237px">
                        ...
                        <asp:ListItem Value="NG" Selected="True">Nigeria</asp:ListItem>
                ...
                <asp:Button ID="btnAdvSearch" runat="server" Text="ADVANCED SEARCH" 
                    onclick="btnAdvSearch_Click" Height="40px" Width="237px" ValidationGroup="g2" />
            </div>
    ...
    <div style="font-size:24px;">
        ...
        <ContentTemplate>
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtSearchBox" runat="server" Height="33px" Width="545px"  ForeColor="#999999"
                    Font-Size="X-Large"></asp:TextBox>                
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtSearchBox" ErrorMessage="*" ValidationGroup="g1"></asp:RequiredFieldValidator>                
                </td>
                <td>
                    <center>
                    <asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click"  Font-Size="24px"
                    Text=" GO! " Height="40px" Width="100px" ValidationGroup="g1"  />                
                    </center>
                </td>
            </tr>
            </table>
            ...
            <asp:LinkButton ID="lnkNewRelevant" runat="server" 
                onclick="lnkNewRelevant_Click" Visible="false">More Relevant Search</asp:LinkButton>
            
            <asp:HyperLink ID="hlnkInfo" runat="server" Font-Size="14px" 
                ForeColor="#FF9900" Visible="false">(search newer ranked items)</asp:HyperLink>
            <br />
            <hr />
            <br />
            <asp:Table ID="tblSearchResult" runat="server" BorderStyle="None">
            </asp:Table>
